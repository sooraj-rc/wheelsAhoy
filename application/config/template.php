...
$template['adminlogin']['template'] = 'template/adminlogin';
...
$template['common_template']['template'] = 'template/common_template';
$template['common_template']['regions'] = array(
   'content',
);
$template['common_template']['parser'] = 'parser';
$template['common_template']['parser_method'] = 'parse';
$template['common_template']['parse_template'] = FALSE;
