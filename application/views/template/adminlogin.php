...
<html>
    <head>
        ...
        <title>WheelsAhoy Admin | Login</title>
        ...
        <style>
            ...
            .login-page, .register-page{
                ...
                background-image: url('assets/img/paper-2.png');                
            }
            .login-box-body{
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">                
                <img src="<?php echo_image('img/logo-1.png'); ?>" class="img-responsive img-center" width="250">
            </div>
            <!-- /.login-logo -->
        ...
        <script src="<?php echo c('js_path_url'); ?>jquery-2.2.3.min.js"></script>
